...
print('Pagelle: inserire 5 voti per materia in CENTESIMI - Voto tra 1 e 100.')


for m in range (1,voti):
...
print(f'La media globale dello studente {nome} {cognome} è: {media_globale}')
